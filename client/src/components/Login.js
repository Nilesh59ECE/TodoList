...
export default function Login(){
    ...
    return(
        <div className="w-11/12 max-w-[500px]  px-10 py-10 rounded-3xl bg-white px-20 py-10 rounded-3xl border-2 border-gray-150">
            <h1 className="mt-7 text-5xl text-center justify-center font-semibold text-blue-900">Login Page</h1>
            ...
            <form onSubmit = {handleSubmit}>
                ...
                <div className="mt-8 flex justify-between items-center">
                    ...
                    <button className="font-medium text-base text-red-500">Forgot password?</button>
                </div>
                <div className="mt-8 flex flex-col gap-y-4">
                    <button className="active:scale[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-2 rounded-xl bg-red-500 text-white text-lg font-bold">Login</button>
                    {/* <button 
            ...
            <div className="mt-8 flex justify-center items-center">
                <p className="font-medium text-base">Don't have an account? <Link to = "/register" className="text-blue-500">Register Here</Link> </p>
            </div>
        </div>
    );
}